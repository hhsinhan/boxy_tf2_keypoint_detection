...
def build(preprocessor_step_config):
  ...
  if step_type == 'remove_small_objects':
    config = preprocessor_step_config.remove_small_objects
    return (preprocessor.remove_small_objects,
            {
                'largest_output_feature_width': config.largest_output_feature_width,
                'largest_output_feature_height': config.largest_output_feature_height,
            })
